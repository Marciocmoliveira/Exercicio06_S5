...
namespace TestProject1
{
    public static class ValidadorDeNumeros
    {
        ...
        {
            // Marca quantas vezes ele é divisível por um número menor que ele
            // Inicia-se em 1 porque todo número é divisível por 1
            int contador = 1;

            // Inicia-se em 1 porque se iniciarmos com 0 na divisão vai dar erro, pois o C# não divide um número por 0.
            for (int n = 1; n < numero; n++)
            {
                if (numero % n == 0)
                {
                    contador = contador + 1;
                    // Tambem pode ser usado: contador++;
                }
            }
